...
\begin{alltt}
\hlcom{# Function to plot relative frequencies}
\hlstd{plot_freq} \hlkwb{<-} \hlkwa{function}\hlstd{(}\hlkwc{x}\hlstd{)\{}
  \hlstd{n} \hlkwb{<-} \hlkwd{length}\hlstd{(x)}
  \hlstd{rel_freq} \hlkwb{<-} \hlkwd{prop.table}\hlstd{(}\hlkwd{table}\hlstd{(x))}
  \hlkwd{plot}\hlstd{(rel_freq,} \hlkwc{ylab} \hlstd{=} \hlstr{'Relative Frequency'}\hlstd{,}
       \hlkwc{xlab} \hlstd{=} \hlkwd{bquote}\hlstd{(n} \hlopt{==} \hlkwd{.}\hlstd{(n)))}
\hlstd{\}}

\hlcom{# Roll a fair die 1 Million times}
\hlkwd{set.seed}\hlstd{(}\hlnum{1234567890}\hlstd{)}
\hlstd{dice} \hlkwb{<-} \hlkwd{sample}\hlstd{(}\hlnum{1}\hlopt{:}\hlnum{6}\hlstd{,} \hlkwc{size} \hlstd{=} \hlnum{1e6}\hlstd{,} \hlkwc{replace} \hlstd{=} \hlnum{TRUE}\hlstd{)}
\end{alltt}
\end{kframe}
\end{knitrout}
\end{frame}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{plot_freq}\hlstd{(dice[}\hlnum{1}\hlopt{:}\hlnum{10}\hlstd{])}
\end{alltt}
\end{kframe}
\includegraphics[width=\maxwidth]{figure/dice_10-1} 
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{plot_freq}\hlstd{(dice[}\hlnum{1}\hlopt{:}\hlnum{50}\hlstd{])}
\end{alltt}
\end{kframe}
\includegraphics[width=\maxwidth]{figure/dice_50-1} 
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{plot_freq}\hlstd{(dice[}\hlnum{1}\hlopt{:}\hlnum{1000}\hlstd{])}
\end{alltt}
\end{kframe}
\includegraphics[width=\maxwidth]{figure/dice_1000-1} 
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{plot_freq}\hlstd{(dice)}
\end{alltt}
\end{kframe}
\includegraphics[width=\maxwidth]{figure/dice_1million-1} 
